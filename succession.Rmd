...
This analysis addresses succession in the presidency of the LDS Church. See Github for [my code](https://github.com/nwstephens/lds). For a comporable analysis see [Church President Probability Changes with President Monson’s Death](http://zelophehadsdaughters.com/2018/01/04/church-president-probability-changes-with-president-monsons-death/#more-12559).

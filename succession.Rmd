...
rawdat <- matrix(
  nrow = 12, 
  byrow = TRUE, 
  dimnames = list(1:12, c("rnk", "name", "dob", "dos")), 
  data=c(
   "1",    "Dallin H. Oaks",             "1932-08-12",    "1984-05-03",
   "2",    "M. Russell Ballard",         "1928-10-08",    "1985-10-10",
   "3",    "Henry B. Eyring",            "1933-05-31",    "1995-04-06",
   "4",    "Dieter F. Uchtdorf",         "1940-11-06",    "2004-10-07",
   "5",    "David A. Bednar",            "1952-06-15",    "2004-10-07",
   "6",    "Quentin L. Cook",            "1940-09-08",    "2007-10-11",
   "7",    "D. Todd Christofferson",     "1945-01-24",    "2008-04-10",
   "8",    "Neil L. Andersen",           "1951-08-09",    "2009-04-09",
   "9",    "Ronald A. Rasband",          "1951-02-06",    "2015-10-08",
  "10",    "Gary E. Stevenson",          "1955-08-06",    "2015-10-08",
  "11",    "Dale G. Renlund",            "1952-11-13",    "2015-10-08",
  "12",    "Gérald Caussé",              "1963-05-20",    "2025-11-06"
  )
)
```
...
```{r}
ggplot(dat2, aes(reorder(nams, 12:1), pct)) +

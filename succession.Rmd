...
This analysis addresses succession in the presidency of the LDS Church. See Github for <a href="https://github.com/nwstephens/lds" target="_blank">N.W. Stephens' code</a>. See <a href="http://zelophehadsdaughters.com/2018/01/04/church-president-probability-changes-with-president-monsons-death/#more-12559" target="_blank">here</a> for a similar analysis. This is an updated and enhanced version of Stephens' code.
...
rawdat <- matrix(
  nrow = 14, 
  byrow = TRUE, 
  dimnames = list(1:14, c("rnk", "name", "dob", "dos")), 
  data=c(
   "1",    "Dallin H. Oaks",             "1932-08-12",    "1984-05-03",
   "2",    "Henry B. Eyring",            "1933-05-31",    "1995-04-06",
   "3",    "Dieter F. Uchtdorf",         "1940-11-06",    "2004-10-07",
   "4",    "David A. Bednar",            "1952-06-15",    "2004-10-07",
   "5",    "Quentin L. Cook",            "1940-09-08",    "2007-10-11",
   "6",    "D. Todd Christofferson",     "1945-01-24",    "2008-04-10",
   "7",    "Neil L. Andersen",           "1951-08-09",    "2009-04-09",
   "8",    "Ronald A. Rasband",          "1951-02-06",    "2015-10-08",
   "9",    "Gary E. Stevenson",          "1955-08-06",    "2015-10-08",
  "10",    "Dale G. Renlund",            "1952-11-13",    "2015-10-08",
  "11",    "Gerrit W. Gong",             "1953-12-23",    "2018-03-31",
  "12",    "Ulisses Soares",             "1958-10-02",    "2018-03-31",
  "13",    "Patrick Kearon",             "1961-07-18",    "2023-12-07",
  "14",    "Gérald Caussé",              "1963-05-20",    "2025-11-06"  # sustained November 6, 2025
 )
)
```
...
`pmat` is a $14 \times Y$ (apostles by `years`) array storing the SSA life table values. `out` is a $Y \times N$ array recording the name of the apostle who is President in year $y$.
...
`pct` is a 14-length vector recording the fraction of simulations in which each apostle became President.
...
`avg_tenure` is a named vector of $\leq 14$ elements where each element is the average tenure for that apostle across all simulations where they became president.
...
```{r}
ggplot(dat2, aes(reorder(nams, 14:1), pct)) +
